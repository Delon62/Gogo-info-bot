...
function buildPreviewComponents() {
  return [
    new ActionRowBuilder().addComponents(
      new ButtonBuilder().setCustomId(customIds.BTN_PREVIEW_SEND).setLabel('Kirim').setEmoji('✅').setStyle(ButtonStyle.Success),
      new ButtonBuilder().setCustomId(customIds.BTN_PREVIEW_EDIT).setLabel('Edit').setEmoji('✏').setStyle(ButtonStyle.Secondary),
      new ButtonBuilder().setCustomId(customIds.BTN_PREVIEW_CANCEL).setLabel('Batal').setEmoji('❌').setStyle(ButtonStyle.Danger),
    ),
  ];
}
